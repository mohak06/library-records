...
def searchrecord(event):
    ...
    for line in lines:
        ...
        if com[0] == entry1.get():
            ...
            entry1.insert(0, com[0]);
            entry2.insert(0, com[1]);
            entry3.insert(0, com[2]);
            entry4.insert(0, com[3]);
            entry5.insert(0, com[4]);
            entry6.insert(0, com[5]);
            break
...
label0 = Label(root, text="                LIBRARY RECORDS", font=("Helvetica", 30))
label0.grid(columnspan=6, padx=10, pady=10)

label1 = Label(root, text='Student Name', font=("Helvetica", 12))
label1.grid(row=6, column=0, sticky=W, padx=10, pady=10)

label2 = Label(root, text='Roll No', font=("Helvetica", 12))
label2.grid(row=7, column=0, sticky=W, padx=10, pady=10)

label3 = Label(root, text='Book Name', font=("Helvetica", 12))
label3.grid(row=8, column=0, sticky=W, padx=10, pady=10)

label4 = Label(root, text='Publisher', font=("Helvetica", 12))
label4.grid(row=9, column=0, sticky=W, padx=10, pady=10)

label5 = Label(root, text='Duration', font=("Helvetica", 12))
label5.grid(row=10, column=0, sticky=W, padx=10, pady=10)

label6 = Label(root, text='Last Date To Reissue', font=("Helvetica", 12))
...
button1 = Button(root, text='Add student ', bg="black", fg="white", width=20, font=("Helvetica", 12))
button1.bind('<Button-1>', addrecord)
button1.grid(row=12, column=0, padx=4, pady=10)

button2 = Button(root, text='Remove student', bg="black", fg="white", width=20, font=("Helvetica", 12))
button2.bind('<Button-1>', removerecord)
button2.grid(row=12, column=1, padx=4, pady=10)

button3 = Button(root, text='Search student ', bg="black", fg="white", width=20, font=("Helvetica", 12))
